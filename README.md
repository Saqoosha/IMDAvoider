...
![FPV周波数組み合わせ結果](fpv_4ch_202508.png)

### 上位10組の周波数組み合わせ

| Rank | 拡張評価 | レガシー評価 | Ch1 | Ch2 | Ch3 | Ch4 |
|------|----------|-------------|-----|-----|-----|-----|
| 1 | 96 | 88 | 5685(E2) | 5725(A8) | 5790(B4) | 5820(F5) |
| 2 | 95 | 84 | 5695(R2) | 5725(A8) | 5785(A5) | 5809(B5) |
| 3 | 92 | 76 | 5685(E2) | 5705(E1) | 5769(R4) | 5800(F4) |
| 4 | 92 | 77 | 5685(E2) | 5705(E1) | 5771(B3) | 5805(A4) |
| 5 | 92 | 76 | 5685(E2) | 5705(E1) | 5771(B3) | 5806(R5) |
| 6 | 92 | 78 | 5685(E2) | 5705(E1) | 5780(F3) | 5820(F5) |
| 7 | 92 | 78 | 5685(E2) | 5705(E1) | 5785(A5) | 5820(F5) |
| 8 | 92 | 75 | 5685(E2) | 5705(E1) | 5790(B4) | 5820(F5) |
| 9 | 92 | 86 | 5695(R2) | 5725(A8) | 5785(A5) | 5820(F5) |
| 10 | 92 | 76 | 5695(R2) | 5732(R3) | 5800(F4) | 5820(F5) |
...
1. Rating: 96 (Legacy: 88) - 5685MHz(E2), 5725MHz(A8), 5790MHz(B4), 5820MHz(F5)
2. Rating: 95 (Legacy: 84) - 5695MHz(R2), 5725MHz(A8), 5785MHz(A5), 5809MHz(B5)
3. Rating: 92 (Legacy: 76) - 5685MHz(E2), 5705MHz(E1), 5769MHz(R4), 5800MHz(F4)
4. Rating: 92 (Legacy: 77) - 5685MHz(E2), 5705MHz(E1), 5771MHz(B3), 5805MHz(A4)
5. Rating: 92 (Legacy: 76) - 5685MHz(E2), 5705MHz(E1), 5771MHz(B3), 5806MHz(R5)
6. Rating: 92 (Legacy: 78) - 5685MHz(E2), 5705MHz(E1), 5780MHz(F3), 5820MHz(F5)
7. Rating: 92 (Legacy: 78) - 5685MHz(E2), 5705MHz(E1), 5785MHz(A5), 5820MHz(F5)
8. Rating: 92 (Legacy: 75) - 5685MHz(E2), 5705MHz(E1), 5790MHz(B4), 5820MHz(F5)
9. Rating: 92 (Legacy: 86) - 5695MHz(R2), 5725MHz(A8), 5785MHz(A5), 5820MHz(F5)
10. Rating: 92 (Legacy: 76) - 5695MHz(R2), 5732(R3), 5800MHz(F4), 5820MHz(F5)

================================================================================
Rank | Rating | Ch1        | Ch2        | Ch3        | Ch4        
--------------------------------------------------------------------------------
   1 |     96 | 5685(E2)   | 5725(A8)   | 5790(B4)   | 5820(F5)  
   2 |     95 | 5695(R2)   | 5725(A8)   | 5785(A5)   | 5809(B5)  
   3 |     92 | 5685(E2)   | 5705(E1)   | 5769(R4)   | 5800(F4)  
   4 |     92 | 5685(E2)   | 5705(E1)   | 5771(B3)   | 5805(A4)  
   5 |     92 | 5685(E2)   | 5705(E1)   | 5771(B3)   | 5806(R5)  
   6 |     92 | 5685(E2)   | 5705(E1)   | 5780(F3)   | 5820(F5)  
   7 |     92 | 5685(E2)   | 5705(E1)   | 5785(A5)   | 5820(F5)  
   8 |     92 | 5685(E2)   | 5705(E1)   | 5790(B4)   | 5820(F5)  
   9 |     92 | 5695(R2)   | 5725(A8)   | 5785(A5)   | 5820(F5)  
  10 |     92 | 5695(R2)   | 5732(R3)   | 5800(F4)   | 5820(F5)  
================================================================================

Detailed IMD Analysis for Best Combination:
Frequencies: [5685, 5725, 5790, 5820]
Enhanced Rating: 96, Legacy Rating: 88
...
Worst 5 interference cases:
  2×5725 - 5685 = 5765 MHz
    Type: 2Nd Order
    Separation: 25 MHz, Score: 100.00
  ...
```
